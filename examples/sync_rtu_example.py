...
def basic_operations_example():
    ...
    print("\n=== 同步RTU基本操作示例 | Sync RTU Basic Operations Example ===")

    # 创建RTU传输层 | Create RTU transport
...
def advanced_data_types_example():
    ...
    print("\n=== 同步RTU高级数据类型示例 | Sync RTU Advanced Data Types Example ===")
...
def sensor_monitoring_example():
    """传感器监控示例 | Sensor monitoring example"""
    print("\n=== 同步RTU传感器监控示例 | Sync RTU Sensor Monitoring Example ===")
...
def main():
    """主函数 | Main function"""
    print("ModbusLink 同步RTU客户端示例 | ModbusLink Sync RTU Client Example")
    print("=" * 60)
