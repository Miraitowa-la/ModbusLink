#!/usr/bin/env python3
"""ModbusLink RTU使用示例 - 展示高级数据类型和日志功能
ModbusLink RTU usage example - Demonstrating advanced data types and logging features
...
def main():
    ...
    print("=== ModbusLink RTU示例 - 高级数据类型和日志功能 ModbusLink RTU Example - Advanced Data Types and Logging ===")
    ...
    try:
        ...
        with client:
            ...
            try:
                ...
                read_device_id = client.read_int32(
                    slave_id=slave_id,
                    start_address=102
                )
            ...
            try:
                ...
                for i in range(3):
                    ...
                    print(f"  第{i+1}次读取 Reading #{i+1}: 温度={temp:.1f}°C, 湿度={humidity:.1f}%, 状态={'运行' if status else '停止'}")
