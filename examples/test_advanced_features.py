...
def test_payload_coder():
    """
    测试数据编解码功能
    Test data encoding/decoding functionality
    """
    ...
    register_count = (len(string_bytes) + 1) // 2  # 每个寄存器2字节
    ...
    test_int64 = 9223372036854775807  # 最大64位有符号整数
    ...
    test_uint32 = 4294967295  # 最大32位无符号整数
...
def test_error_handling():
    ...
    try:
        # 无效的寄存器数据长度
        PayloadCoder.decode_float32([1, 2, 3])  # 应该是2个寄存器
    except ValueError as e:
...
def main():
    ...
    try:
        ...
        print("\n" + "=" * 60)
        print("✓ 所有测试完成 All tests completed successfully")
