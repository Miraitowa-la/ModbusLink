"""ModbusLink CRC16校验工具模块 ModbusLink CRC16 Checksum Utility Module

提供Modbus RTU协议所需的CRC16校验功能。 Provides CRC16 checksum functionality required by Modbus RTU protocol.
"""


class CRC16Modbus:
    """Modbus CRC16校验工具类 Modbus CRC16 Checksum Utility Class
    ...
    def crc16_to_int(data: bytes) -> int:
        """计算CRC16校验码并返回整数值 Calculate CRC16 Checksum and Return Integer Value
