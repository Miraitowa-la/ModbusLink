"""ModbusLink 日志系统 Logging System

提供统一的日志配置和管理功能。 Provides unified logging configuration and management functionality.
"""
...
class ModbusLogger:
    """ModbusLink日志管理器 ModbusLink Logger Manager
    
    提供统一的日志配置和格式化功能。 Provides unified logging configuration and formatting functionality.
    """
    ...
    def enable_protocol_debug() -> None:
        """启用协议级别的调试日志 Enable protocol-level debug logging
