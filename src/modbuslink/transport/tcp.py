"""ModbusLink TCP传输层实现 TCP Transport Layer Implementation
...
class TcpTransport(BaseTransport):
    """Modbus TCP传输层实现 Modbus TCP Transport Layer Implementation
    
    处理基于TCP/IP的Modbus TCP通信，包括： Handles Modbus TCP communication based on TCP/IP, including:
    ...
    def send_and_receive(self, slave_id: int, pdu: bytes) -> bytes:
        ...
        实现TCP协议的完整通信流程： Implements complete TCP protocol communication flow:
